...
def predict(img, W1, b1, W2, b2, W3, b3):
    _, _, _, _, _, A3 = forward_prop(W1, b1, W2, b2, W3, b3, img.T)
...
def main():
    ...
    w1 = wb_file_input("Weights 1 file name? (default: W1.txt):", "W1.txt", (256, 256))
    w2 = wb_file_input("Weights 2 file name? (default: W2.txt):", "W2.txt", (256, 256))
    w3 = wb_file_input("Weights 3 file name? (default: W3.txt):", "W3.txt", (256, 10))
    B1 = wb_file_input("Biases 1 file name? (default: b1.txt):", "b1.txt", (256, 1), True)
    B2 = wb_file_input("Biases 2 file name? (default: b2.txt):", "b2.txt", (256, 1), True)
    ...
    while True:
        pixels = inputs.input()
        inputs.output(predict(pixels.T.reshape(pixels.T.shape[0], 1), w1, B1, w2, B2, w3, B3)[0])
